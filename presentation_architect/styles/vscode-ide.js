...
module.exports = {
    render: async function(blueprint, outputPath = 'presentation_output.pptx') {
        ...
        blueprint.slides.forEach(slideData => {
            ...
            if (slideData.layout_type === 'IDE01-cover') {
            ...
            else if (slideData.layout_type === 'IDE02-mac-window') {
            ...
            else if (slideData.layout_type === 'IDE03-agent-grid') {
            ...
            else if (slideData.layout_type === 'IDE04-chat-flow') {
        ...
        return pres.writeFile({ fileName: outputPath }).then(() => {
            console.log(`[vscode-ide] Presentation generated successfully at ${outputPath}`);
        });
